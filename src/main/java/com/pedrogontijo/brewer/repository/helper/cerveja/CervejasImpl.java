...
import com.pedrogontijo.brewer.repository.paginacao.PaginacaoUtil;
...
public class CervejasImpl implements CervejasQueries {
	...
	public List<CervejaDTO> porSkuOuNome(String skuOuNome) {
		String jpql = "select new com.pedrogontijo.brewer.dto.CervejaDTO(codigo, sku, nome, origem, valor, foto) "
	...
	public ValorItensEstoque valorItensEstoque() {
		String query = "select new com.pedrogontijo.brewer.dto.ValorItensEstoque(sum(valor * quantidadeEstoque), sum(quantidadeEstoque)) from Cerveja";
